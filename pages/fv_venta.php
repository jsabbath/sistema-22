        ...
        <div id="main-wrapper">
            ...
            <div id="content-wrapper">
                <ul class="breadcrumb breadcrumb-page">
                    ...
                    <li><a href="fv_venta.php">Ingreso</a></li>
                    <!--                    <li class="active"><a href="#">Dashboard</a></li>-->
                </ul>
                <div class="page-header">
                    <h1><span class="text-light-gray">Factura de venta / </span>Ingreso</h1>
                </div> <!-- / .page-header -->
...
<!--                            <div class="panel-heading">
        ...
        <script src="../js/paginas/fv_venta.js" ></script>
        ...
        <script type="text/javascript">
            ...
            $("#fact_rut").focusout(function () {
                ...
                if ($("#fact_rut").val().length > 9) {
                    consultarCliente(<?php echo $_SESSION['empresa_def_id'] ?>);
                }
            });
