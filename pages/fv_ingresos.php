...
<!--[if gt IE 9]><!--> <html class="gt-ie8 gt-ie9 not-ie"> <!--<![endif]-->
    ...
    <body class="<?php echo $_SESSION['template'] ?> main-menu-animated main-navbar-fixed main-menu-fixed">
        ...
        <div id="main-wrapper">
            ...
            <div id="content-wrapper">
                <ul class="breadcrumb breadcrumb-page">
                    ...
                    <li><a href="fc_egresos.php">Ingresos</a></li>
                    <!--                    <li class="active"><a href="#">Dashboard</a></li>-->
                </ul>
                <div class="page-header">
                    <h1><span class="text-light-gray">Facturas de ventas / </span>Ingresos</h1>
                </div> <!-- / .page-header -->
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="" id="egresos_prove">
                                            <select id="combo_proveedor" class="form-control">
                                                <option></option>
                                                <?php $fun->getClieproveConEmpresa($_SESSION['empresa_def_id'], 2); ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                        <div class="" id="egresos_mes">
                                            <select id="ingresos_combo_mes" class="form-control">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="" id="egresos_ano">
                                            <select id="ingresos_combo_ano" class="form-control">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="btn-toolbar " >
                                            <button type="button" onclick="ListarDatos();" class="btn btn-success btn-block">
                                ...
                                <div class="row">
                                    <div class="table-primary">
                                        <table id="listado_ingresos" class="table table-striped table-bordered dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                            <thead>
                                                <tr role="row">
                                                    <th style="width: 3%;" ></th>
        ...
        <script src="../js/paginas/fv_ingresos.js" ></script>
