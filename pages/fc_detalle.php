...
if (!isset($_GET['idfact']) || !isset($_GET['fact']) || !isset($_GET['prove'])) {
    ...
    $factura = $_GET['fact'];
    $prove = $_GET['prove'];
    $_SESSION['fc_adjunto_idfact'] = $idfactura;
}
        ...
        <div id="main-wrapper">
            ...
            <div id="content-wrapper">
                <ul class="breadcrumb breadcrumb-page">
                    ...
                    <li><a href="fc_detalle.php<?php echo"?idfact=$idfactura&fact=$factura&prove=$prove" ?>">Detalle</a></li>
                    <!--                    <li class="active"><a href="#">Dashboard</a></li>-->
                </ul>
                <div class="page-header">
                    <div class="pull-left col-sm-4">
                        <h1><span class="text-light-gray">Factura de compra / </span>Detalle</h1> 
                        <br>
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="btn-toolbar ">
                                            <button type="button" id="btn_edit" onclick="editarFc();" class="btn btn-warning btn-block" <?php
                                    ...
                                    <div class="col-sm-1">
                                        <div class="btn-toolbar ">
                                            <button type="button" id="btn_save" onclick="guardarFc();" class="btn btn-success btn-block" <?php
                                            if ($_SESSION['fact_mod'] == 0) {
                                                echo "disabled";
                                            }
                                            ?>>
                                    ...
                                    <div class="col-sm-1">
                                        <div class="btn-toolbar ">
                                            <button type="button" id="btn_eli_fc" onclick="eliminarFactura();" class="btn btn-danger btn-block" <?php
                                            if ($_SESSION['fact_mod'] == 0) {
                                                echo "disabled";
                                            }
                                            ?>>
            ...
            <script src="../js/paginas/fc_detalle.js" ></script>
            ...
            <script type="text/javascript">
                ...
                function cargarArchivos() {
                    $('#factura_archivos').dataTable({
                        "ajax": "../conection/fc_detalle.php?idfact=<?php echo $idfactura; ?>",
                        "columns": [
                            {"data": "tipo"},
                            {"data": "archivo"},
                            {"data": "fecha"},
