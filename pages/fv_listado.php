...
<!--[if gt IE 9]><!--> <html class="gt-ie8 gt-ie9 not-ie"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>Listado Facturas de ventas</title>
    ...
    <body class="<?php echo $_SESSION['template'] ?> main-menu-animated main-navbar-fixed main-menu-fixed">
        ...
        <div id="main-wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="page-header">
                    <h1><span class="text-light-gray">Factura de venta / </span>Listado</h1>
                </div> <!-- / .page-header -->
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="btn-toolbar " >
                                            <button type="button" onclick="recargarFv();"  class="btn btn-success btn-block">
                                    ...
                                    <div class="col-sm-1">
                                        <div class="btn-toolbar " >
                                            <button type="button" id="pagoFv" class="btn btn-danger btn-block">
                                ...
                                <div class="row">
                                    <div class="table-primary">
                                        <table id="tabla_facturasFv" class="table table-striped table-bordered dataTable no-footer" cellspacing="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                            <thead>
                                                <tr role="row">
                                                    <th style="width: 3%;"></th>
        ...
        <script src="../js/paginas/fv_listado.js" ></script>
