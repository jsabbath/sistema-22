...
if (!isset($_GET['corre_eg'])) {
    header("location:fc_egresos.php");
} else {
    $corre_eg = $_GET['corre_eg'];
}
...
<!--[if gt IE 9]><!--> <html class="gt-ie8 gt-ie9 not-ie"> <!--<![endif]-->
    ...
    <head>
        ...
        <title>Detalle del Egreso <?php echo $corre_eg; ?></title>
        ...
        <div id="main-wrapper">
            ...
            <div id="content-wrapper">
                <ul class="breadcrumb breadcrumb-page">
                    ...
                    <li><a href="#">Egreso de compra</a></li>
                    <li><a href="fc_egreso_detalle.php<?php echo"?idfact=$idfactura&fact=$factura&prove=$prove" ?>">Detalle</a></li>
                    <!--                    <li class="active"><a href="#">Dashboard</a></li>-->
                </ul>
                <div class="page-header">
                    <div class="pull-left col-sm-4">
                        <h1><span class="text-light-gray">Egreso de compra / </span>Detalle</h1> 
                        <br>
                        <h1 id="numero_factura"><b>Nº <?php echo $corre_eg; ?></b></h1>
                    </div>
                </div> <!-- / .page-header -->
                            ...
                            <div class="panel-body">
                                        ...
                                        <div class="row">  
                                            <div class="col-lg-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="egreso_fecha" class="form-control" id="egreso_fecha" readonly>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-sm-6 col-xs-8">
                                                <div class="form-group">
                                                    <label>Documento Pago</label>
                                                    <input type="text" name="egreso_documento" class="form-control" id="egreso_documento" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">  
                                            <div class="col-lg-6 col-sm-4 col-xs-4">
                                                <div class="form-group" id="tipo_grupo">
                                                    <label for="egreso_tipo_pago">Tipo Pago</label><br>
                                                    <select id="egreso_tipo_pago" class="form-control" disabled>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <div class="form-group">
                                                    <label>Total</label>
                                                    <input type="text" name="egreso_total_pago" class="form-control" id="egreso_total_pago" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">  
                                            <div class="col-lg-10 col-sm-8 col-xs-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="egreso_prove_nombre" class="form-control" id="egreso_prove_nombre" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">  
                                            ...
                                            <div class="col-lg-12  col-sm-12 col-xs-12">
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="form-control" rows="3" name="egreso_glosa" id="egreso_glosa" readonly></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <div class="row"> 
                                                        ...
                                                        <div class="col-lg-3 col-sm-1">
                                                            <div class="btn-toolbar " >
                                                                <button type="button" onclick="cargarDataTableEgresoDetalle();" class="btn btn-default btn-block">
                                                ...
                                                <div class="panel-body">
                                                    <div class="table-primary">
                                                        <table id="egreso_adjuntos" class="table table-striped table-bordered dataTable no-footer" cellspacin="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                                            <thead>
                                                                <tr role="row">
                                ...
                                <div class="col-lg-6"> <!-- panel derecha -->
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="table-primary">
                                                <table id="egreso_facturas" class="table table-striped table-bordered dataTable no-footer" cellspacin="0" width="100%" role="grid" aria-describedby="example_info" style="width: 100%;">
                                                    <thead>
                                                        <tr role="row">
            ...
            <script src="../js/paginas/fc_egreso_detalle.js"></script>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    //cargarArchivos();
                    extraerEgreso("<?php echo $corre_eg; ?>");
                    //$("#example").popover();
                });
