...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			...
			this.fnInfo( '<h6>Datos Copiados</h6>'+
				'<p>Copiadas '+lines+' fila'+plural+' al porta papeles.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h5>Vista de impresión</h5><p>Utilice la función de impresión de su navegador para imprimir esta tabla. Presione escapar cuando haya terminado.</p>",
		"sMessage": null,
		"bShowAll": true,
